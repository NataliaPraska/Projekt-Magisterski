...
% Mam problem ze słownictwem bo w teori takie słowa jak haptyczny to dosyć podstawowe słowo w zakresie vr ale pytałam kilka osób poglądowo(8) i nie znają znaczenia niektórych tego typu słów mimo doświadczenia w grach (równnież VR).

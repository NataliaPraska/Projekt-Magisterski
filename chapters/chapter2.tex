...
Przyjęty podział interfejsów VR opiera się na rozwiązaniach najczęściej opisywanych w literaturze oraz stosowanych w istniejących grach i aplikacjach. Jego celem nie jest tworzenie nowej klasyfikacji, lecz uporządkowanie obserwowanych podejść projektowych w sposób umożliwiający ich dalszą analizę.

Pozwala to lepiej zrozumieć, w jakich sytuacjach i w jakim celu poszczególne rozwiązania są wykorzystywane. W niniejszej analizie przyjęto podział interfejsów na cztery główne typy:
...
Różne typy interfejsów VR implikują odmienne konsekwencje projektowe. Interfejsy silnie zintegrowane ze światem gry mogą sprzyjać poczuciu immersji, lecz jednocześnie wymagać od użytkownika większego wysiłku poznawczego oraz nauki nowych schematów interakcji. Z kolei rozwiązania bardziej konwencjonalne, wywodzące się z interfejsów 2D i 3D, bywają łatwiejsze do przyswojenia, lecz mogą w większym stopniu zaburzać wrażenie obecności w wirtualnym środowisku.
...
\subsection{Narzędzia badawcze: UEQ, Skala Likerta i Telemetria}

...
W którym miejscu będę mogła wstawić informacje dotyczące tworzenia Ankiety wyboru grupy docelowej itp.

Bardzo nie podoba mi się przegląd literatury jako osobny rozdział, czy jest szansa bym mogła robić to tak jak było to robione w Pracy inżynierskiej i jak miały to osoby w tamtym roku np Marcin i Bartek Lauks czy Tetiana. Żaden z nich nie miał Przeglądu Literatury.
Czy ma pan jakieś uwagi dotyczące ankiety?
Czy aktualna struktura Panu odpowiada?
Czy jesli jakieś badanie będzie tylko ppodrozdziałem w rozdziale to czy przez komisje nadal bedzie to uwzgledniane jako element badawczy?

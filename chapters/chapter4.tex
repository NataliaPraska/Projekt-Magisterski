\chapter{Badania wstępne i projekt prototypu}



\section{Metodyka badań}

\section{Ankieta wstępna}
...
\subsection{Grupa badawcza i sposób dystrybucji}
...
\subsection{Prezentacja wyników i wnioski}

\section{Projekt wariantów prototypu menu}

\subsection{Tworzenie prototypów interfejsów użytkownika dla VR}
\subsection{Testowanie różnych układów elementów i metod interakcji}
%(kontrolery, gesty, głos).

\section{Test A/B prototypu}
\subsection{Grupa badawcza i sposób dystrybucji}
\subsection{Założenia konstrukcyjne}
\subsection{Prezentacja wyników i wnioski}